...
function sendNotif() { // tx) {
  ...
  const options = {
    token: {
      key: '/Users/harshagoli/Documents/AuthKey_WRW2C2M995.p8',
      keyId: 'WRW2C2M995',
      teamId: 'JMP9D48WN6'
    },
    production: false
  ...
  const deviceTokens = ['072f6b04ab1d8b76f4fcd44dc0fcf778a5e871325f4181cdea474036857d4175'];

  const notification = new apn.Notification();
  notification.alert = 'Fuck you Sri Im a node';
  notification.badge = 1;
  notification.topic = 'com.harsha.Hail';

  apnProvider.send(notification, deviceTokens).then( (response) => {
    console.log("\n\n\n\n\n\n\n\n\n\n\n"+util.inspectify(response))
